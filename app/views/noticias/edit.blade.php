...
@section('content')
{{Form::open(['method'=>'PUT', 'url'=>'admin/noticias/'.$noticia->id, 'class'=>'form-horizontal', 'id'=>'newsForm'])}}
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
        	<input class="form-control" type="text" name="enlace" id="enlace" value="{{$noticia->enlace}}">
	...
	<div class="form-group">
    	...
    	<div class="col-lg-9">
    		<textarea class='editor' name="noticia" id="news">{{$noticia->noticia}}</textarea>
